...
public class RemedyHelper extends EntityHelper {
	...
	public String getSpecificRemedy(String id) {
		...
		if (results.hasNext()) {
			...
			while (itt.hasNext()) {
				...
				medicalFactor.setMedicalFactorName(medicalFactorRes.getURI().substring(OntologyUtils.NS.length()).replaceAll("_", " "));
				medicalFactor.setMedicalFactorId(Long.valueOf(medicalFactorRes.getPropertyValue(hasMedicalFactorId).toString()));
	...
	public JsonArray getQueryResults(ArrayList<String> adjuvantEffects, ArrayList<String> therapeuticalEffects,
		...
		for (String adjuvant : adjuvantEffects) {
			...
			String clas = "?class" + i;
			sparqlQueryString += " ?subject sedic:hasAdjuvantUsage " + individual + ".";
			sparqlQueryString += individual + " a  " + clas + "." + clas + " rdfs:subClassOf* " + adjuvant + ".";
		...
		for (String th : therapeuticalEffects) {
			...
			sparqlQueryString += individual + " a  " + clas + "." + clas + " rdfs:subClassOf* " + th + ".";
